...
| **13 Feb 2026** | Student Relationships | `Student` + `AadharCard` + `HostelRoom` — chained `@OneToOne` JPA associations | PostgreSQL | ![Hibernate](https://img.shields.io/badge/Hibernate-59666C?style=flat-square&logo=hibernate&logoColor=white) |
| **13 Feb 2026** | Price Service Testing | `PriceService` + `DiscountRepository` — service-layer isolation with `PriceServiceTest` | — | ![Mockito](https://img.shields.io/badge/Mockito-C5D9C8?style=flat-square) ![JUnit5](https://img.shields.io/badge/JUnit5-25A162?style=flat-square&logo=junit5&logoColor=white) |
| **14 Feb 2026** | E-Commerce System | `User`, `Profile`, `PurchaseOrder`, `Payment` — DAOs + `EcommerceServiceTest` | MySQL | ![Hibernate](https://img.shields.io/badge/Hibernate-59666C?style=flat-square&logo=hibernate&logoColor=white) |
| **14 Feb 2026** | Hospital Management | `Doctor`, `Patient`, `Appointment`, `MedicalRecord` — domain-driven JPA + `HospitalServiceTest` | MySQL | ![Hibernate](https://img.shields.io/badge/Hibernate-59666C?style=flat-square&logo=hibernate&logoColor=white) |
| **16 Feb 2026** | Social Media Posts | `Users`, `Post`, `Comments` — `@OneToMany` modelling a social feed | MySQL | ![Hibernate](https://img.shields.io/badge/Hibernate-59666C?style=flat-square&logo=hibernate&logoColor=white) |
| **21 Feb 2026** | CRM Sales Management | `Customer`, `Lead`, `SalesEmployee`, `Product`, `Order`, `SupportTicket` — full service-layer with `CustomerService`, `LeadService`, `OrderService`, `TicketService`, `ReportService` | PostgreSQL | ![Hibernate](https://img.shields.io/badge/Hibernate-59666C?style=flat-square&logo=hibernate&logoColor=white) |
| **21 Feb 2026** | Hospital Management ERP | `Patient`, `MedicalRecord`, `Department`, `Doctor`, `Appointment`, `Prescription` — **all 5 JPA mapping types** covered across `CRUDTest1` through `CRUDTest5` | PostgreSQL | ![Hibernate](https://img.shields.io/badge/Hibernate-59666C?style=flat-square&logo=hibernate&logoColor=white) |
