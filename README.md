...
| Date | Project Folder | Assignment Title | Entities / Focus | DB | Key Tech |
|:-----|:---------------|:-----------------|:-----------------|:---|:---------|
| **10 Feb 2026** | `10-Feb-2026-Assignment` | Product Management | `Product` — full Hibernate CRUD + `ProductCrudTest` (JUnit 5) | PostgreSQL | ![Hibernate](https://img.shields.io/badge/Hibernate-59666C?style=flat-square&logo=hibernate&logoColor=white) ![JUnit5](https://img.shields.io/badge/JUnit5-25A162?style=flat-square&logo=junit5&logoColor=white) |
| **11 Feb 2026** | `11-Feb-2026-Assignment` | Passport System | `Person` + `Passport` — `@OneToOne` mapping, `PersonCrudTest` + `PassportCrudTest` | PostgreSQL | ![Hibernate](https://img.shields.io/badge/Hibernate-59666C?style=flat-square&logo=hibernate&logoColor=white) ![JUnit5](https://img.shields.io/badge/JUnit5-25A162?style=flat-square&logo=junit5&logoColor=white) |
| **12 Feb 2026** | `12-Feb-2026-Assignment` | Student DAO (JDBC) | `Student` + `StudentDao` — DAO pattern over raw JDBC, `StudentDaoTest` | PostgreSQL | ![JDBC](https://img.shields.io/badge/JDBC-007396?style=flat-square&logo=java&logoColor=white) ![JUnit5](https://img.shields.io/badge/JUnit5-25A162?style=flat-square&logo=junit5&logoColor=white) |
| **13 Feb 2026** | `13-Feb-Assignment-OneToOne` | Student Relationships | `Student` + `AadharCard` + `HostelRoom` — chained `@OneToOne` JPA associations | PostgreSQL | ![Hibernate](https://img.shields.io/badge/Hibernate-59666C?style=flat-square&logo=hibernate&logoColor=white) |
| **13 Feb 2026** | `13-Feb-2026-Assignment-Mockito` | Price Service Testing | `PriceService` + `DiscountRepository` — service-layer isolation with `PriceServiceTest` | — | ![Mockito](https://img.shields.io/badge/Mockito-C5D9C8?style=flat-square) ![JUnit5](https://img.shields.io/badge/JUnit5-25A162?style=flat-square&logo=junit5&logoColor=white) |
| **14 Feb 2026** | `14-Feb-Assignment-CaseStudy1` | E-Commerce System | `User`, `Profile`, `PurchaseOrder`, `Payment` — DAOs + `EcommerceServiceTest` | MySQL | ![Hibernate](https://img.shields.io/badge/Hibernate-59666C?style=flat-square&logo=hibernate&logoColor=white) |
| **14 Feb 2026** | `14-Feb-Assignment-CaseStudy2` | Hospital Management | `Doctor`, `Patient`, `Appointment`, `MedicalRecord` — domain-driven JPA + `HospitalServiceTest` | MySQL | ![Hibernate](https://img.shields.io/badge/Hibernate-59666C?style=flat-square&logo=hibernate&logoColor=white) |
| **16 Feb 2026** | `16-Feb-Assignment` | Social Media Posts | `Users`, `Post`, `Comments` — `@OneToMany` modelling a social feed | MySQL | ![Hibernate](https://img.shields.io/badge/Hibernate-59666C?style=flat-square&logo=hibernate&logoColor=white) |
| **21 Feb 2026** | `21-Feb-Assignment-crm_sales_management_system` | CRM Sales Management | `Customer`, `Lead`, `SalesEmployee`, `Product`, `Order`, `SupportTicket` — full service-layer with `CustomerService`, `LeadService`, `OrderService`, `TicketService`, `ReportService` | PostgreSQL | ![Hibernate](https://img.shields.io/badge/Hibernate-59666C?style=flat-square&logo=hibernate&logoColor=white) |
| **21 Feb 2026** | `21-Feb-Assignment-hospitalManagementSystemERP` | Hospital Management ERP | `Patient`, `MedicalRecord`, `Department`, `Doctor`, `Appointment`, `Prescription` — **all 5 JPA mapping types** covered across `CRUDTest1` through `CRUDTest5` | PostgreSQL | ![Hibernate](https://img.shields.io/badge/Hibernate-59666C?style=flat-square&logo=hibernate&logoColor=white) |
